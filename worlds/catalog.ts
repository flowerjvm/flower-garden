...
export const WORLD_CATALOG = [
  {
    ...
    summary:
      "한 번의 Worker tick이 Flow를 어떻게 움직이는지, 씨앗이 피어나는 네 번의 실행으로 익힙니다.",
    difficulty: "입문",
    estimatedMinutes: "5–7분",
    scenarioLabel: "1 mission · 4 ticks",
    prerequisites: [],
    concepts: ["Engine", "Worker", "Flow", "Step", "StepResult"],
    learningHighlights: [
      "Worker의 한 tick이 Flow를 한 번 전진시킵니다.",
      "STAY와 DONE의 차이를 실제 StepResult로 확인합니다.",
      "다음 Step으로 이동하는 tick과 실행하는 tick의 경계를 봅니다.",
    ],
    accent: "bloom",
  },
  {
